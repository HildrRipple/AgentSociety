                ...
                translation: {
                    ...
                    form: {
                        agent: {
                            ...
                            numberOrProfileRequired: "Please provide either a number or select a profile",
                            numberOrProfileExclusive: "Cannot provide both number and profile - please choose one",
                ...
                translation: {
                    ...
                    form: {
                        agent: {
                            ...
                            numberOrProfileRequired: "请提供智能体数量或选择配置文件",
                            numberOrProfileExclusive: "不能同时提供智能体数量和配置文件，请选择其中一项",
