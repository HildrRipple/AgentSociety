      ...
      <Row gutter={16}>
        <Col span={6}>
          <Form.Item
            ...
            label="Firms"
            initialValue={1}
            rules={[{ required: true, message: 'Please input number of firms' }]}
            style={{ marginBottom: 8 }}
          >
            <InputNumber min={1} style={{ width: '100%' }} />
          </Form.Item>
        ...
        <Col span={6}>
          <Form.Item
            ...
            label="Government"
            initialValue={1}
            rules={[{ required: true, message: 'Please input number of government' }]}
            style={{ marginBottom: 8 }}
          >
            <InputNumber min={1} style={{ width: '100%' }} />
          </Form.Item>
        ...
        <Col span={6}>
          <Form.Item
            ...
            label="Banks"
            initialValue={1}
            rules={[{ required: true, message: 'Please input number of banks' }]}
            style={{ marginBottom: 8 }}
          >
            <InputNumber min={1} style={{ width: '100%' }} />
          </Form.Item>
        ...
        <Col span={6}>
          <Form.Item
            ...
            label="NBS"
            initialValue={1}
            rules={[{ required: true, message: 'Please input number of NBS' }]}
            style={{ marginBottom: 8 }}
          >
            <InputNumber min={1} style={{ width: '100%' }} />
          </Form.Item>
