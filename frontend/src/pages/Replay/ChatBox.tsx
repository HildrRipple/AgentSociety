...
export const ChatBox = observer(() => {
    ...
    const handleSelectSubmit = async () => {
        ...
        // 进行其他操作
        const res = await fetchWithAuth(`/api/experiments/${store.expID}/agents/${agent?.id}/survey`, {
            method: 'POST',
        ...
        {type === 2 && <>
            <Sender
                ...
                onSubmit={async (content: string) => {
                    ...
                    const res = await fetchWithAuth(`/api/experiments/${store.expID}/agents/${agent.id}/dialog`, {
                        method: 'POST',
                        headers: { 'Content-Type': 'application/json' },
