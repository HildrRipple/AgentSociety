...
async def run_experiment(
    ...
    try:
        # 将配置转换为 base64
        sim_config_base64 = base64.b64encode(json.dumps(config.environment).encode()).decode()
        ...
        cmd = [
            ...
            "--network", "host",  # 使用主机网络，以便访问 Redis 等服务
            "agentsociety-runner",
    ...
    try:
        ...
        if process.returncode != 0:
            ...
            if container_status == "running":
                ...
                # 获取退出码
                exit_code_cmd = ["docker", "inspect", "--format={{.State.ExitCode}}", container_id]
    ...
    try:
        ...
        if status_process.returncode == 0:
            ...
            if exit_code == 0:
                ...
                logger.error(f"Experiment {experiment_id} failed with exit code {exit_code}")
